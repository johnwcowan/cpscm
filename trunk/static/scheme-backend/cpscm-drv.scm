...
(define-record-type :cpscm__delay (cpscm__delay-create thunk) cpscm__delay? (thunk cpscm__delay-thunk))
...
(define cpscm%cpscm:normal-apply apply)
...
(define cpscm_20_make-promise (lambda (g:k113 cpscm_proc_41) (cpscm__trampoline ((lambda (cpscm_result-ready?_42 cpscm_result_43) (cpscm__trampoline (g:k113 (lambda (g:k118) (cpscm__trampoline ((lambda (g:ret-_20_boolean->combinator:120) (cpscm__trampoline (g:ret-_20_boolean->combinator:120 g:k118 (lambda (g:k122) (cpscm__trampoline (g:k122 cpscm_result_43))) (lambda (g:k124) (cpscm__trampoline (cpscm_proc_41 (lambda (g:ret-_proc_41:126) (cpscm__trampoline ((lambda (g:ret-_20_boolean->combinator:130) (cpscm__trampoline (g:ret-_20_boolean->combinator:130 g:k124 (lambda (g:k132) (cpscm__trampoline (g:k132 cpscm_result_43))) (lambda (g:k134) (cpscm__trampoline (begin (cpscm__reduce-trampoline (set! cpscm_result-ready?_42 #t)) (cpscm__reduce-trampoline (set! cpscm_result_43 g:ret-_proc_41:126)) (cpscm__reduce-trampoline (g:k134 cpscm_result_43)))))))) (cpscm_20_boolean->combinator cpscm_result-ready?_42)))))))))) (cpscm_20_boolean->combinator cpscm_result-ready?_42))))))) #f #f))))
(define cpscmappend! cpscmappend)
(define cpscmappend-reverse (lambda (g:k138 cpscm_rev-head_41 cpscm_tail_42) (cpscm__trampoline (cpscmreverse (lambda (g:ret-reverse:140) (cpscm__trampoline (cpscmappend g:k138 g:ret-reverse:140 cpscm_tail_42))) cpscm_rev-head_41))))
(define cpscmappend-reverse! cpscmappend-reverse)
(define cpscmreverse! cpscmreverse)
(define cpscmmap (lambda (g:k142 cpscm_f_41 cpscm_l_42) (cpscm__trampoline ((lambda (cpscm_loop_43) (cpscm__trampoline ((lambda (g:k149 cpscm_loop_43_tmp) (cpscm__trampoline (g:k149 (set! cpscm_loop_43 cpscm_loop_43_tmp)))) (lambda (g146) (cpscm__trampoline (cpscm_loop_43 g:k142 cpscm_l_42 (quote ())))) (lambda (g:k152 cpscm_l_44 cpscm_res_45) (cpscm__trampoline (cpscmnull? (lambda (g:ret-null?:155) (cpscm__trampoline ((lambda (g:ret-_20_boolean->combinator:154) (cpscm__trampoline (g:ret-_20_boolean->combinator:154 g:k152 (lambda (g:k157) (cpscm__trampoline (cpscmreverse! g:k157 cpscm_res_45))) (lambda (g:k160) (cpscm__trampoline (cpscmcdr (lambda (g:ret-cdr:162) (cpscm__trampoline (cpscmcar (lambda (g:ret-car:165) (cpscm__trampoline (cpscm_f_41 (lambda (g:ret-_f_41:164) (cpscm__trampoline (cpscmcons (lambda (g:ret-cons:163) (cpscm__trampoline (cpscm_loop_43 g:k160 g:ret-cdr:162 g:ret-cons:163))) g:ret-_f_41:164 cpscm_res_45))) g:ret-car:165))) cpscm_l_44))) cpscm_l_44)))))) (cpscm_20_boolean->combinator g:ret-null?:155)))) cpscm_l_44)))))) (quote undefined)))))
(define cpscmfor-each (lambda (g:k167 cpscm_k_41 cpscm_f_42 cpscm_l_43) (cpscm__trampoline ((lambda (cpscm_loop_44) (cpscm__trampoline ((lambda (g:k174 cpscm_loop_44_tmp) (cpscm__trampoline (g:k174 (set! cpscm_loop_44 cpscm_loop_44_tmp)))) (lambda (g171) (cpscm__trampoline (cpscm_loop_44 g:k167 cpscm_l_43 (quote ())))) (lambda (g:k177 cpscm_l_45) (cpscm__trampoline (cpscmnull? (lambda (g:ret-null?:180) (cpscm__trampoline ((lambda (g:ret-_20_boolean->combinator:179) (cpscm__trampoline (g:ret-_20_boolean->combinator:179 g:k177 (lambda (g:k182) (cpscm__trampoline (g:k182 #t))) (lambda (g:k184) (cpscm__trampoline (cpscmcar (lambda (g:ret-car:186) (cpscm__trampoline (cpscm_f_42 (lambda (g:ret-_f_42:185) (cpscm__trampoline (cpscmcdr (lambda (g:ret-cdr:188) (cpscm__trampoline (cpscm_loop_44 g:k184 g:ret-cdr:188))) cpscm_l_45))) g:ret-car:186))) cpscm_l_45)))))) (cpscm_20_boolean->combinator g:ret-null?:180)))) cpscm_l_45)))))) (quote undefined)))))
(define cpscmassoc (lambda (g:k190 cpscm_x_41 cpscm_lis_42 . cpscm_maybe-=_43) (cpscm__trampoline (cpscmnull? (lambda (g:ret-null?:194) (cpscm__trampoline ((lambda (g:ret-_20_boolean->combinator:193) (cpscm__trampoline (g:ret-_20_boolean->combinator:193 (lambda (g:ret-apply:192) (cpscm__trampoline (cpscmfind g:k190 (lambda (g:k199 cpscm_entry_45) (cpscm__trampoline (cpscmcar (lambda (g:ret-car:201) (cpscm__trampoline (g:ret-apply:192 g:k199 cpscm_x_41 g:ret-car:201))) cpscm_entry_45))) cpscm_lis_42))) (lambda (g:k203) (cpscm__trampoline (g:k203 cpscmequal?))) (lambda (g:k205) (cpscm__trampoline (cpscmcar g:k205 cpscm_maybe-=_43)))))) (cpscm_20_boolean->combinator g:ret-null?:194)))) cpscm_maybe-=_43))))
(define cpscmassq (lambda (g:k208 cpscm_x_41 cpscm_l_42) (cpscm__trampoline (cpscmassoc g:k208 cpscm_x_41 cpscm_l_42 cpscmeq?))))
(define cpscmassv (lambda (g:k211 cpscm_x_41 cpscm_l_42) (cpscm__trampoline (cpscmassoc g:k211 cpscm_x_41 cpscm_l_42 cpscmeqv?))))
(define cpscmmember (lambda (g:k214 cpscm_x_41 cpscm_lis_42 . cpscm_maybe-=_43) (cpscm__trampoline (cpscmnull? (lambda (g:ret-null?:218) (cpscm__trampoline ((lambda (g:ret-_20_boolean->combinator:217) (cpscm__trampoline (g:ret-_20_boolean->combinator:217 (lambda (g:ret-apply:216) (cpscm__trampoline (cpscmfind-tail g:k214 (lambda (g:k223 cpscm_y_45) (cpscm__trampoline (g:ret-apply:216 g:k223 cpscm_x_41 cpscm_y_45))) cpscm_lis_42))) (lambda (g:k226) (cpscm__trampoline (g:k226 cpscmequal?))) (lambda (g:k228) (cpscm__trampoline (cpscmcar g:k228 cpscm_maybe-=_43)))))) (cpscm_20_boolean->combinator g:ret-null?:218)))) cpscm_maybe-=_43))))
(define cpscmmemq (lambda (g:k231 cpscm_x_41 cpscm_l_42) (cpscm__trampoline (cpscmmember g:k231 cpscm_x_41 cpscm_l_42 cpscmeq?))))
(define cpscmmemv (lambda (g:k234 cpscm_x_41 cpscm_l_42) (cpscm__trampoline (cpscmmember g:k234 cpscm_x_41 cpscm_l_42 cpscmeqv?))))
