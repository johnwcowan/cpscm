;; SRFI-1 reference implementation, modified by Dan Muresan to
;; include definitions for receive, let-optionals, :optional and 
;; check-arg.
;; Source: http://srfi.schemers.org/srfi-1/srfi-1-reference.scm
